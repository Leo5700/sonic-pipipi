...
#ax.plot(aw[0], aw[1], '.')
#ax.plot(777, np.interp(777, aw[0], aw[1]), 'ro')
...
#ax.plot(aw[0], abydb(aw[0], aw[1]), '.')
#ax.plot(777, np.interp(777, aw[0], abydb(aw[0], aw[1])), 'ro')
...
#        Pxx_den_stack[j] = Pxx_den
        Pxx_den_stack[j] = np.interp(Pxx_den, aw[0], abydb(aw[0], aw[1]))  # A-weighting
